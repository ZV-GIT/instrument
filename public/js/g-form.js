$(function () {
  $(".g-form").submit(function (event) {
    ...
    let appLink = "https://script.google.com/macros/s/AKfycbzhJXclJsVL8cT7X1ubhplM8kbksWyUkQNlfOsmYQdNnNkJN8cT-JpBxEM6Z1NXedi-/exec";
    ...
    $.ajax({
      ...
      if (jqXHR.readyState === 4 && jqXHR.status === 200) {
        ...
        popupfinish.classList.toggle("open");
